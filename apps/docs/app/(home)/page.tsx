...
import { Blocks, Cpu, Library, SquareTerminal } from "lucide-react";
...
export default function HomePage() {
  return (
    <main>
      ...
      <section className="container grid gap-6 pb-8 lg:grid-cols-3">
        <Card>
          <CardHeader>
        ...
        <Card>
          ...
          <CardContent>
            Manage DNS records from config files, that can be pushed to Git and
            deployed by CI.
          </CardContent>
        </Card>
      </section>
